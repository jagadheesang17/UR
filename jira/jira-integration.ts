...
// Jira API URL and credentials - Load from environment variables
const url = process.env.JIRA_URL || "https://your-domain.atlassian.net/rest/api/2/issue/";
const username = process.env.JIRA_USERNAME || "your-email@example.com";
const apiKey = process.env.JIRA_API_KEY || "your-api-key-here";
const projectId = process.env.JIRA_PROJECT_ID || "PROJECT_KEY";
