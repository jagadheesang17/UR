...
test(`verify that a department can be added under Metadata Library - People - Department`, async ({createCourse, adminHome, metadatalibrary }) => {
    ...
    await metadatalibrary.name(departmentName);
       await createCourse.enterCode("DEP-" + generateCode());
...
test(`verify that a employment type can be added under Metadata Library - People - Employment Type`, async ({ createCourse,adminHome, metadatalibrary }) => {
    test.info().annotations.push(
        { type: 'Author', description: 'Ajay Michael' },
    ...
    await createCourse.enterCode("EMP-" + generateCode());
    await metadatalibrary.description(FakerData.getDescription());
    await metadatalibrary.saveButton();
...
test(`verify that a user type can be added under Metadata Library - People - User Type`, async ({createCourse, adminHome, metadatalibrary }) => {
    test.info().annotations.push(
        { type: 'Author', description: 'Ajay Michael' },
    ...
    await createCourse.enterCode("USRT-" + generateCode());
...
test(`verify that a job role can be added under Metadata Library - People - Job Role`, async ({ createCourse,adminHome, metadatalibrary }) => {
    test.info().annotations.push(
        { type: 'Author', description: 'Ajay Michael' },
    ...
    await createCourse.enterCode("JR-" + generateCode());
    await metadatalibrary.description(FakerData.getDescription());
    await metadatalibrary.saveButton();
...
test(`verify that a job title can be added under Metadata Library - People - Job Title`, async ({ createCourse,adminHome, metadatalibrary }) => {
    test.info().annotations.push(
        { type: 'Author', description: 'Ajay Michael' },
    ...
    await createCourse.enterCode("JT-" + generateCode());
    await metadatalibrary.description(FakerData.getDescription());
    await metadatalibrary.saveButton();
