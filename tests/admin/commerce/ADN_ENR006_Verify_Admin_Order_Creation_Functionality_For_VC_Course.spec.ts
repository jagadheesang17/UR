...
test.describe(`Confirm that Admin Order creation functions correctly and as expected for VC Course`, async () => {
    test.describe.configure({ mode: "serial" });
    test(`Creation of multi instnce VC Course and Admin creates an order`, async ({ adminHome, catalog, costCenter, createCourse, enrollHome, contentHome }) => {
