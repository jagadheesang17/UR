...
//             { type: `TestCase`, description: `Creation of Single Instance Elearning with Tincan content` },
//             { type: `Test Description`, description: `Verify that course should be created for Tincan` }
//         );
