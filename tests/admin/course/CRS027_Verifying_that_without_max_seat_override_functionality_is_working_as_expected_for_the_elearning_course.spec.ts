...
test.describe(`Verify that without Max Seat Override functionality is working as expected for the eLearning course`, async () => {
    test.describe.configure({ mode: "serial" });
    test(`Verifying that without Max Seat Override functionality is working as expected for the eLearning course`, async ({ siteAdmin,adminHome,learnerHome}) => {
