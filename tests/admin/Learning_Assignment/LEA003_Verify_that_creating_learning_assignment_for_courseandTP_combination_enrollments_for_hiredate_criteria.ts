...
const title = FakerData.getCourseName();
    ...
    test(`Creation of learning assingment for Hire date criteria Course and TP combination`, async ({ adminHome,createUser, learningPath, createCourse, learningAssignment, contentHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Nithya` },
            { type: `TestCase`, description: `Creation of learning assingment for Hire date criteria course and TP combination` },
            { type: `Test Description`, description: `Creation of learning assingment for Hire date criteria course and TP combination` }
        );
