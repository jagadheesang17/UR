...
test(`Verifying that user address validation functionality working as expected for valid address on Profile page`, async ({ siteAdmin,adminHome,learnerHome}) => {
...
test(`Verify that user address validation functionality working as expected for valid address on Profile page`, async ({ adminHome, createUser,contentHome }) => {
    test.info().annotations.push(
        { type: `Author`, description: `Tamilvanan` },
...
test(`Verify that user address validation functionality working as expected for valid address on the profile page`, async ({ learnerHome,createUser,profile}) => {
    test.info().annotations.push(
        { type: `Author`, description: `Tamilvanan` },
    ...
    for (const row of data) {
       ...
       //await learnerHome.termsAndConditionScroll();
        ...
        await profile.typeAddress("Address 2", address2);
