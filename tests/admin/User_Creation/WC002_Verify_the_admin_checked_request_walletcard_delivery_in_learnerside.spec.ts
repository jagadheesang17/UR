...
// )
// test(`Verify the error message displayed when the created learner attempts to select the "Request Wallet Card Delivery" option without completing at least one course.`, async ({ learnerHome,profile}) => {
//     test.info().annotations.push(
