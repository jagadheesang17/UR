...
test.describe(`TC104 Verify past Class recurring Registration`, async () => {
    ...
    test(`TC104_Recurring Registration for past date`, async ({ createCourse, adminHome, editCourse }) => {
        test.info().annotations.push(
            ...
            { type: `TestCase`, description: `Verify Multiple Course Creation for Classroom and Elearning ` },
            { type: `Test Description`, description: `Multiple Course Creation for Classroom and Elearning ` }
        );
    ...
    test(`Verification from learner site`, async ({ learnerHome, learnerCourse, catalog }) => {
        test.info().annotations.push(
            ...
            { type: `Test Description`, description: `Verify that learner can reenroll the classroom course` }
        );
